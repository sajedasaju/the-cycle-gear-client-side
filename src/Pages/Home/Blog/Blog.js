...
const Blog = () => {
    return (
        <div className="w-10/12 md:w-7/12 lg:6/12 mx-auto relative py-20">
            <h2 className='text-2xl text-center mb-12 font-bold border-y-2 py-3 font-serif text-primary text-[#7aad3b]'>Blogs</h2>
            <div className="border-l-2 mt-10">

                <div className="transform transition cursor-pointer hover:-translate-y-2 ml-10 relative flex items-center px-6 py-4 bg-[#b7cba0ed]  text-black rounded mb-10 flex-col md:flex-row space-y-4 md:space-y-0">

                    <div className="w-5 h-5 bg-[#b7cba0ed] absolute -left-10 transform -translate-x-2/4 rounded-full z-10 mt-2 md:mt-0"></div>


                    <div className="w-10 h-1 bg-[#b7cba0ed] absolute -left-10 z-0"></div>

                    <div className="flex-auto ">

                        <h1 className="text-lg font-bold  mb-3">How will you improve the performance of a React Application?</h1>
                ...
                <div className="transform transition cursor-pointer hover:-translate-y-2 ml-10 relative flex items-center px-6 py-4 bg-[#b7cba0ed]  text-black rounded mb-10 flex-col md:flex-row space-y-4 md:space-y-0">
                    ...
                    <div className="flex-auto">
                        <h1 className="text-xl font-bold  mb-3">Why you do not set the state directly in React?</h1>
