        ...
        <>
            ...
            <section className='w-4/5 mx-auto  my-20'>
                ...
                <div className='flex items-end mr-3 mt-6'>
                    <Link to='/allTool' className=" ml-auto inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white  rounded-lg focus:ring-4 focus:outline-none   bg-[#7aad3b] hover:padding-x-2 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-[#5b7d33]  duration-300">
                        Manage Inventories
