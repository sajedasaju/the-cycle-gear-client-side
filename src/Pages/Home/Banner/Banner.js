...
const Banner = () => {
    return (
        ...
        <div class="z-30 relative items-center justify-center w-full h-full overflow-auto">
            <div class="inset-0 h-screen bg-cover bg-center bgImageSize"
                style={{
                    'backgroundImage': `url(${banner1})`
                }}
            >
        ...
        //     }}
        //     class="hero min-h-screen bg-base-200 bg-gradient-to-r from-[#78b3d5] to-[#0325367b]">
        //     <div class="hero-content flex-col lg:flex-row">
        //         <img src={banner1} class="max-w-sm lg:max-w-lg rounded-lg shadow-2xl" />
