          ...
          <div className="md:flex items-center -mx-10">
            ...
            <div className="w-full md:w-1/2 px-10">
              ...
              <div className=" flex flex-col md:flex-row lg:flex-row justify-between items-center justify-items-center">
                ...
                <div className="inline-block align-bottom">
                  <button className=" opacity-75 hover:opacity-100 text-white hover:text-gray-900 rounded-full px-10 py-2 font-semibold bg-gradient-to-l from-[#87c738] to-[#4b7420] ">
      ...
      <section className="text-gray-600 body-font" id="#order">
        ...
        >
          <div className="lg:w-3/5 lg:pr-0 pr-0">
            <h1 className="title-font font-medium font-bold text-5xl text-[#81B441]">
              Want to add this product to your cart?
            </h1>
            <p className="leading-relaxed mt-4 text-white text-lg">
              You can add the product bu give all needed information.and boom
              ,it will added to your order list..
            </p>
          </div>
          ...
          <div className="lg:w-2/6 xl:w-2/5 md:w-2/3 bg-gray-100 rounded-lg p-8 flex flex-col lg:ml-auto w-full mt-10 lg:mt-0">
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="relative form-control w-full mb-2">
                ...
                <input
                  className="title bg-gray-100 border border-gray-300 p-2  outline-none w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                  spellCheck="false"
                  value={user.email}
                  type="text"
                  {...register("email")}
              ...
              <div className="relative form-control w-full mb-0">
                <label for="order" className="leading-7 text-sm text-gray-600">
                  Order Quantity
                </label>

                <input
                  className="title bg-gray-100 border border-gray-300 p-2  outline-none title bg-gray-100 border border-gray-300 p-2  outline-none w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                  spellCheck="false"
                ...
                <input
                  ...
                  {...register("phone", {
                    required: {
                      value: true,
                      message:
                        "Please provide your phone number ! its required",
                    },
                  })}
                />
                <label className="label">
              ...
              <div className="buttons flex">
                ...
                {errors.minimumOrder ? (
                  <button
                    disabled
                    type="submit"
                    className="text-white px-4 w-auto h-10 bg-[#758664b9] rounded hover:opacity-.5 active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none"
                  >
                    Add
                  </button>
                ) : (
                  <button
                    type="submit"
                    className="text-white px-10 w-auto h-10   hover:bg-[#4f692f] active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none bg-gradient-to-l from-[#87c738] to-[#4b7420] rounded-full hover:bg-[#4f692f]"
                  >
                    Add
                  </button>
                )}
