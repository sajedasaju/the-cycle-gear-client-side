    ...
    return (
        ...
        <div className="relative w-full h-full flex justify-end bg-gradient-to-t from-black via-transparent to-black overflow-hidden">
            ...
            <div className="relative py-28 xl:py-40 w-full md:w-2/3 lg:w-1/2 h-full flex flex-col justify-center">
                ...
                {/* ::Hero title & text */}
                <div className="mx-5 md:mx-0 p-8 rounded-xl md:rounded-r-none bg-gray-800 bg-opacity-80 text-white shadow-2xl">
                    <h1 className="text-3xl sm:text-5xl font-josefin font-extrabold">Why   <br /><span className="text-[#7aad3b] text-opacity-80">The Cycle Gear</span>  <br />Best In This Field !</h1>
                    <p className="mt-3 text-gray-100 font-firacode">From creating a workplace environment where employees can be their authentic selves, to being a responsible business with a commitment to the community – we're breaking down barriers and helping to foster opportunity for all.</p>

                    {/* ::Hero button */}
                    <button className="relative m-5 mb-2 w-full md:w-2/3 lg:w-2/5 inline-flex items-center text-2xl font-firacode text-white overflow-hidden transition-all duration-300 transform hover:translate-x-4">
                ...
                {/* ::Social media */}
                <div className="absolute top-4 sm:top-auto bottom-auto sm:bottom-20 md:bottom-0 -right-16 md:right-0 h-36 inline-flex md:flex-col justify-around items-center text-white transform -translate-x-1/2">
                    {/* Twitter */}
                    <Link to='/' className="mx-3 transform hover:scale-110">
            ...
            <div className="absolute left-1/2 bottom-0 w-full md:w-2/3 flex justify-around items-end transform -translate-x-1/2">
                {/* ::Our Story */}
                <Link to='/' className="group relative py-5 w-40 rounded-t-xl bg-white bg-opacity-80 text-center text-gray-600 font-semibold font-firacode transition-all duration-300 transform hover:pb-14">
                    Our Story
