...
const Footer = () => {
    ...
    return (
        ...
        <footer className="p-4 sm:p-6 bg-white shadow-2xl bg-[#ffff]">
            <ScrollToTop smooth component={<ScrollTop />} />

            <div className='container mx-auto '>
                <div className="max-w-screen-xl mx-auto mb-12 lg:mb-16   bg-[#ffff]">
                ...
                <div className="sm:flex sm:items-center sm:justify-between pb-4 ">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400"> <small>copyright @ {new Date().getFullYear()}</small> All Rights Reserved To <span className='font-bold text-[#81B441] text-xl'>Sajeda</span>
                    </span>
                    <div className="flex items-center gap-x-4 ">


                        <a href='https://www.facebook.com/profile.php?id=100010466556130'>
                            <svg className="h-6 w-6 fill-current text-[#81B441] hover:text-[#4d6e26] mr-6" viewBox="0 0 512 512">
                                <path d="M455.27,32H56.73A24.74,24.74,0,0,0,32,56.73V455.27A24.74,24.74,0,0,0,56.73,480H256V304H202.45V240H256V189c0-57.86,40.13-89.36,91.82-89.36,24.73,0,51.33,1.86,57.51,2.68v60.43H364.15c-28.12,0-33.48,13.3-33.48,32.9V240h67l-8.75,64H330.67V480h124.6A24.74,24.74,0,0,0,480,455.27V56.73A24.74,24.74,0,0,0,455.27,32Z" />
                            </svg>
                        </a>
                        <Link to='/'>
                            <svg fill="none" className="h-6 w-6 text-[#81B441]  hover:text-[#4d6e26] mr-6" viewBox="0 0 24 24" stroke="currentColor">
