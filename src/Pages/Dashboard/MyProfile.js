  ...
  return (
    <div>
      <div class="max-w-5xl sm:mr-auto mr-auto ">
        ...
        <div class="mb-12">
          <div class="bg-[#b7cba0ed]  rounded-md rounded-br-[100px] sm:rounded-br-[250px] w-full shadow-md flex flex-wrap flex-col-reverse md:flex-row p-6 sm:p-8 w-full">
            <div class="w-full sm:w-2/3 text-center sm:text-left">
              <h1 class="text-3xl sm:text-5xl font-bold text-gray-100 sm:leading-relaxed mt-4">
                Your Profile Can Update As You Want
              </h1>
              <p class="text-white text-sm sm:text-base py-4 sm:pr-5">
                Update your profile if needed.
              </p>
              <button class="px-6 py-3 bg-pink-500 text-gray-200 mt-4 mb-8 text-base font-medium rounded-md shadow-md hover:text-gray-50 hover:bg-[#577a2c]  bg-[#7aad3b] ">
                Update Now
              </button>
            </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl justify-center my-24">
          ...
          <div className="relative form-control w-full mb-0">
            <label for="education" className="leading-7 text-sm text-gray-600">
              Education
            </label>
            <input
              type="text"
          ...
          {/* //Linkedin */}
          <div className="relative form-control w-full mb-0">
            <label for="linkedin" className="leading-7 text-sm text-gray-600">
              Linkedin
            </label>
            <input
              type="text"
          ...
          <div className="flex flex-col md:flex-row lg:flex-row xl:flex-row gap-3">
            ...
            <div className="relative form-control w-full mb-0">
              <label for="district" className="leading-7 text-sm text-gray-600">
                District
              </label>
              <input
                type="text"
          ...
          <div className="buttons flex">
            <button
              type="submit"
              className="text-white px-4 w-auto h-10  rounded  active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none  hover:bg-[#577a2c]  bg-[#7aad3b] "
            >
              Update
            </button>
          </div>
