    ...
    <div className="">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl justify-center mb-24">
            ...
            <input
              ...
              {...register("minimumOrder", {
                required: {
                  value: true,
                  message:
                    "Please provide tool minimum order quantity ! its required",
                },
            ...
            <input
              ...
              {...register("availableQuantity", {
                required: {
                  value: true,
                  message:
                    "Please provide tool available quantity ! its required",
                },
                min: {
                  value: 1,
          ...
          <div className="form-control w-full ">
            <textarea
              className="description bg-gray-100 sec p-3 h-48	 border border-gray-300 outline-none"
              spellCheck="false"
          ...
          <div className="buttons flex">
            <button
              type="submit"
              className="text-white px-4 w-auto h-10 bg-amber-600 rounded hover:bg-[#56792a] active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none bg-secondary "
            >
              Add
            </button>
          </div>
