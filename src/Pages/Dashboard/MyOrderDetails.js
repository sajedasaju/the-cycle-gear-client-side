    ...
    <div className="mt-4 md:mt-6 flex flex-col md:flex-row justify-start items-start md:items-center md:space-x-6 xl:space-x-8 w-full">
      ...
      <div className="border-b border-gray-200 md:flex-row flex-col flex justify-between items-start w-full pb-8 space-y-4 md:space-y-0">
        <div className="w-full flex flex-col justify-start items-start space-y-6">
          <h3 className="text-lg dark:text-white xl:text-2xl font-semibold leading-6 text-gray-800">
            {toolName}
          </h3>
          <div className="flex justify-start items-start flex-col space-y-2">
            <p className="text-lg dark:text-white leading-none text-[#498322] font-bold">
              <span className="dark:text-black text-black font-normal">
                Ordered Quantity:{" "}
              </span>{" "}
              {orderedQuantity}
            </p>
        ...
        <div className="flex justify-between space-x-8 items-start w-full">
          <p className=" text-[#81B441] xl:text-3lg leading-6 text-xl font-extrabold ">
            ${price}
          </p>
          ...
          {order.price && order.paid && (
            <div className="flex flex-col items-end">
              ...
              <br />
              <p className="text-success flex flex-col break-word items-end">
                Transaction Id :{" "}
