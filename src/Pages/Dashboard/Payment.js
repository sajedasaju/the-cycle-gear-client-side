...
const Payment = () => {
    const { id } = useParams()
    const url = `https://protected-anchorage-05977.herokuapp.com/order/${id}`
                ...
                <div className="flex flex-wrap -m-4  ">
                    <div className="p-4 lg:w-1/2 ">
                        <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left  bg-blue-100 rounded-lg p-4">
                            <img alt="team" className="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4" src={order.img} />
                            <div className="flex-grow sm:pl-8">
                                <h2 className=" font-medium text-lg text-gray-900">
                                    You pay for
                                    <span className="title-font font-medium text-lg text-green-900"> {order.toolName}</span></h2>
                                <p className="mb-2">Quantity:<span>{order.orderedQuantity}</span></p>
                                <h3 className="text-gray-500 mb-2"><span className='text-xl font-bold'>${order.price}</span></h3>
