...
const MyReview = () => {
    ...
    const onSubmit = data => {
        ...
        //send to  database
        fetch('https://protected-anchorage-05977.herokuapp.com/review', {
            method: "POST",
            headers: {
                ...
                <div className="hero-content flex-col lg:flex-row-reverse py-10">
                    ...
                    <div className="card flex-shrink-0 w-full max-w-lg shadow-2xl bg-base-100 order-last  lg:order-first xl:order-first">
                        ...
                        <div className="card-body py-4">
                            ...
                            <div className="px-12 ">
                                <h2 className="text-gray-800 text-3xl font-semibold justify-center text-center">Your opinion matters to us!</h2>
                            </div>
                            <div className="bg-gray-200 w-full flex flex-col items-center">
                                <div className="flex flex-col items-center  space-y-3">
                                    <span className="text-lg text-gray-800">How was quality of our services?</span>
                                ...
                                <div className="w-3/4 flex flex-col pt-2">
                                    <form onSubmit={handleSubmit(onSubmit)} >
                                        ...
                                        <div className="form-control w-full max-w-xs">
                                            ...
                                            } className="select w-full max-w-xs input-bordered  text-gray-500 rounded-xl resize-none" required>
                                        ...
                                        <button className="py-2 font-bold px-4 mb-6 text-lg bg-gradient-to-l from-[#78a640] to-[#6e8159]  rounded-xl text-white mx-auto w-full ">Rate now</button>
                                    </form>

                                </div>
                            </div>
                            <div className="flex items-center justify-center">
                                <Link to='/' className="text-gray-600">Maybe later</Link>
                            </div>
